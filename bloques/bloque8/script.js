(() => {
  const data = window.DRONLAB_BLOQUE8;
  ...
  const notesKey = 'dronlab_a2_bloque8_notes';
  ...
  function renderSlide(slide, i) {
    ...
    const body = i === 0
      ? `<div class="hero-grid"><div class="hero-copy"><p class="eyebrow">CURSO UAS - A2</p><h1>${escapeHtml(slide.titulo)}</h1><p class="subtitle">${escapeHtml(slide.objetivo)}</p><div class="institutional-pill"><img src="../../assets/branding/logo-circular-fab.png" alt=""><span>Circular FAB Jarandilla de la Vera</span></div><div class="hero-tags"><span>Ver</span><span>Entender</span><span>Aplicar</span><span>Recordar</span></div></div><div class="drone-visual" aria-label="Diagrama del examen teorico oficial A2"><div class="system-card"><span class="icon">E</span><b>Bloque Base</b><small>Matriculacion, televigilancia e integridad</small></div></div></div>`
    ...
    const finalAccess = i === data.slides.length - 1
      ? `<div class="callout"><b>Examen final del curso:</b> el Motor de Evaluacion pertenece al curso, no al bloque. <a class="pill" href="../../examen-final/index.html">Abrir examen final A2</a></div>`
      : '';
    return `
