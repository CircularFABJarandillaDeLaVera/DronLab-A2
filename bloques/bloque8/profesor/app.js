(() => {
  ...
  function show(i) {
    ...
    const key = `dronlab_a2_b8_nota_${s.id}`;
    ...
    c.innerHTML = `
      ...
      <div class="grid">
        ...
        <article class="card box"><h3>Sugerencia metodologica</h3><p>${pp.sugerencias_metodologicas || 'Mantener la explicacion dentro de la ingenieria del Bloque 8.'}</p></article>
