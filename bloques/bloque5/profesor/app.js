(() => {
  ...
  function show(i) {
    ...
    const key = `dronlab_a2_b5_nota_${s.id}`;
    ...
    c.innerHTML = `
      ...
      <div class="grid">
        ...
        <article class="card box"><h3>Memorizar</h3>${list(pp.memorizar || [])}</article>
        <article class="card box"><h3>Comprender</h3>${list(pp.comprender || [])}</article>
        <article class="card box"><h3>Aplicar</h3>${list(pp.aplicar || [])}</article>
        ...
        <article class="card box"><h3>Sugerencia metodologica</h3><p>${pp.sugerencias_metodologicas || 'Mantener la explicacion conectada a rendimiento, configuracion y seguridad operacional.'}</p></article>
        ...
        <article class="card box"><h3>Competencias trabajadas</h3>${list(pp.competencias_trabajadas || [])}</article>
