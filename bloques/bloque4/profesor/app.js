(() => {
  ...
  function show(i) {
    ...
    const key = `dronlab_a2_b4_nota_${s.id}`;
    ...
    c.innerHTML = `
      ...
      <div class="grid">
        ...
        <article class="card box"><h3>Sugerencia metodologica</h3><p>${pp.sugerencias_metodologicas || 'Mantener la explicacion conectada a meteorologia, entorno y decision Go/No-Go.'}</p></article>
