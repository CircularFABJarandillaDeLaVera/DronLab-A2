(() => {
  const data = window.DRONLAB_BLOQUE4;
  ...
  const notesKey = 'dronlab_a2_bloque4_notes';
  ...
  function renderSlide(slide, i) {
    ...
    const body = i === 0
      ? `<div class="hero-grid"><div class="hero-copy"><p class="eyebrow">CURSO UAS - A2</p><h1>${escapeHtml(slide.titulo)}</h1><p class="subtitle">${escapeHtml(slide.objetivo)}</p><div class="institutional-pill"><img src="../../assets/branding/logo-circular-fab.png" alt=""><span>Circular FAB Jarandilla de la Vera</span></div><div class="hero-tags"><span>Ver</span><span>Entender</span><span>Aplicar</span><span>Recordar</span></div></div><div class="drone-visual" aria-label="Diagrama de meteorologia A2"><div class="system-card"><span class="icon">M</span><b>Bloque Base</b><small>Meteorologia y decision Go/No-Go</small></div></div></div>`
