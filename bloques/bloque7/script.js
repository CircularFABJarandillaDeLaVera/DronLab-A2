(() => {
  const data = window.DRONLAB_BLOQUE7;
  ...
  const notesKey = 'dronlab_a2_bloque7_notes';
  ...
  function renderSlide(slide, i) {
    ...
    const body = i === 0
      ? `<div class="hero-grid"><div class="hero-copy"><p class="eyebrow">CURSO UAS - A2</p><h1>${escapeHtml(slide.titulo)}</h1><p class="subtitle">${escapeHtml(slide.objetivo)}</p><div class="institutional-pill"><img src="../../assets/branding/logo-circular-fab.png" alt=""><span>Circular FAB Jarandilla de la Vera</span></div><div class="hero-tags"><span>Ver</span><span>Entender</span><span>Aplicar</span><span>Recordar</span></div></div><div class="drone-visual" aria-label="Diagrama de autoformacion practica A2"><div class="system-card"><span class="icon">A</span><b>Bloque Base</b><small>Autoformacion, fases A-E y declaracion</small></div></div></div>`
